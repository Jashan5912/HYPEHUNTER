...
def index():
    ...
    def links_returning(name:str):
        pattern=r"\s+"#removing white spaces for generating links
        name = re.sub(pattern, "", name)


        return ('https://www.google.com/search?tbm=shop&hl=en-GB&psb=1&ved=0CAAQvOkFahcKEwiopoOr9_2CAxUAAAAAHQAAAAAQGA&q='+name)
    ...
    return render_template('index.html', tech_data=tech_data, sports_data=sports_data, health_data=health_data)
